...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6 col-xs-6">
            ...
            <a href="user_listing.php"><button type="button" class="btn btn-success pull-right addNewBtn">Back</button></a>
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" id="uploadphoto" name="choosefile" required>
                    </div>
                </div>
...
if (isset($_POST['submit_form'])) {
    ...
    $query = "INSERT INTO users (first_name, last_name, email, contact_number, dob, city, active) 
               VALUES ('$firstName', '$lastName', '$email', $Contact, '$dateofbirth', '$city', $active)";
